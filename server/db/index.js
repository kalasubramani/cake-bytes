...
const seed = async () => {
  ...
  const [foo, bar, bazz, quq] = await Promise.all([
    ...
    createProduct({ name: 'Tower of Flowers Cake', price: 200.00, description: 'This beautiful blue two-tiered cake is great for weddings or showers.  It is carefully adorned with hundreds of delicate white flowers.  Inside the cake is a lightly lemon-flavored chiffon cake with a lemon mousse sandwiched between the cake layers.', vip_price: 180.00, category: 'Special Occasions', productImage: flowerCake_image }),
    ...
    createProduct({ name: 'Peony Cake', price: 200.00, description: "This small three-layer cake makes a great casual wedding cake or is perfect for Mother's Day. It features a vanilla cake with whip cream frosting. The flowers on top are handpiped and edible.", vip_price: 0, category: 'Special Occasions', productImage: peonyCake_image }),
