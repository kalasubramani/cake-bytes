...
const seed = async () => {
  ...
  const cupcakeLetters_image = 'https://plus.unsplash.com/premium_photo-1663839412165-0d60a57e7a91?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDF8fGN1cGNha2VzJTIwd2l0aCUyMGNhbmRsZXN8ZW58MHwxfDB8fHww';
  ...
  const [foo, bar, bazz, quq] = await Promise.all([
    ...
    createProduct({ name: 'Adorable Dreams', price: 45.00, description: "This cake is not just a treat for the taste buds but a feast for the eyes. Perfect for capturing adorable moments with the birthday baby. Soft pastels with touches of baby blue, pink, and sunshine yellow.  Layers of moist vanilla sponge filled with light and fluffy strawberry cream, capturing the essence of pure sweetness.", vip_price: 35.50, category: 'Special Occasions', productImage: babyBabyCake_image }),
    createProduct({ name: 'Decadent Chocolate Bliss', price: 50.00, description: ' Indulge in the rich and velvety layers of our Decadent Chocolate Bliss cake. Each bite is a symphony of deep, dark chocolate flavors that dance on your taste buds, creating a sensory celebration for chocolate enthusiasts. Adorned with dark chocolate curls, this cake is a visual feast as much as it is a culinary delight. Perfect for any occasion, this chocolate masterpiece is equally suitable for intimate gatherings, birthdays, or as a decadent treat for no reason at all.', vip_price: 0, category: 'Birthdays', productImage: beatlesCake_image }),
    createProduct({ name: 'Safari Adventure Delight', price: 250.00, description: "Embark on a wild journey with our Safari Adventure Delight, a jungle-themed cake that brings the magic of the wild right to your celebration.Vibrant greens, earthy browns, and pops of tropical colors create a visually stunning edible jungle landscape. Adorable edible giraffes, lions, elephants, and monkeys peek out from lush fondant foliage, adding a touch of safari charm. The cake layers transport you to a delicious jungle scene, with edible 'mud' frosting at the base. ", vip_price: 0, category: 'Special Occasions', productImage: jungleCake_image }),
    createProduct({ name: 'Desert Bloom Delight', price: 40.00, description: ' Immerse yourself in the beauty of the desert with our "Desert Bloom Delight" cactus-themed cake. Beneath the edible succulents lies a delectable surprise. Layers of moist vanilla sponge complemented by a subtle hint of prickly pear or agave nectar-infused filling, creating a harmonious blend of flavors.', vip_price: 0, category: 'Special Occasions', productImage: cactusCake_image }),
    createProduct({ name: 'Frosty Spirits Elegance', price: 50.00, description: `Our "Frosty Spirits Elegance" Winter Rum Cake is a delightful celebration of the season's charm, bringing together the cozy warmth of winter with the rich, spirited essence of rum.`, vip_price: 40.50, category: 'Holidays', productImage: christmasTrainCakes_image }),
    createProduct({ name: 'Simplicity', price: 3.00, description: 'Perfect for any occasion, our plain cupcakes are a blank slate awaiting your personal touch. Whether topped with a swirl of luscious buttercream, a dusting of powdered sugar, or accompanied by fresh berries, these cupcakes are the foundation for your culinary imagination.', vip_price: 2.50, category: 'Cupcakes', productImage: cupcakeLetters_image }),
    createProduct({ name: 'Velvet Indulgence', price: 4.00, description: 'Dive into a world of culinary luxury with our "Velvet Indulgence" Red Velvet Cupcakes. The signature deep red hue of these cupcakes is a visual prelude to the indulgence that awaits. Perfect for any occasion, from casual gatherings to formal celebrations. "Velvet Indulgence" Red Velvet Cupcakes are a versatile treat that elevates every moment.', vip_price: 0, category: 'Cupcakes', productImage: earlGreyCupcakes_image }),
    createProduct({ name: 'Waffle Cap Delights', price: 4.00, description: 'Indulge in the perfect marriage of breakfast comfort and dessert luxury with our "Waffle Cap Delights" cupcakes. These treats seamlessly blend the warmth of waffles with the sweetness of cupcakes. The cupcakes boast a light and fluffy texture, mirroring the delicate crispiness of waffles. The golden-brown edges add a charming visual appeal, inviting you to savor every bite.', vip_price: 0, category: 'Cupcakes', productImage: elmoCupcakes_image }),
    createProduct({ name: 'Ruffled Elegance', price: 60.00, description: `Our "Ruffled Elegance Masterpiece" is a visual feast that combines the art of baking with the grace of intricate design. Each layer is meticulously adorned with delicate fondant or frosting ruffles, creating a stunning display of culinary craftsmanship.  Choose from a spectrum of colors that harmonize with your celebration theme. Whether it's soft pastels, vibrant hues, or a monochromatic masterpiece, the Ruffles Cake is customizable to suit your taste.`, vip_price: 50.00, category: 'Birthdays', productImage: rufflesCake_image }),
    createProduct({ name: 'Pistachio Bliss', price: 60.00, description: 'Revel in the perfect balance of nuttiness and sweetness, as the pistachio-infused cake layers unfold a delicate flavor profile. The cake boasts a velvety texture that melts in your mouth, creating a luxurious and satisfying sensation. The pistachio essence enhances the overall richness, making it a true treat for the senses.', vip_price: 0, category: 'Birthdays', productImage: flashCake_image }),
    createProduct({ name: 'Blooms of Elegance', price: 60.00, description: `The color palette mirrors the soft hues of a spring garden—pastel pinks, blues, and greens. It's a visual feast that evokes the freshness and vibrancy of blooming flowers in full bloom.  Whether it's a wedding, bridal shower, or a birthday celebration, "Blooms of Elegance" adds a touch of natural beauty and sophistication to any special occasion.`, vip_price: 50.00, category: 'Special Occasions', productImage: flowerCake_image }),
    createProduct({ name: "Botanical Blooms Delight", price: 5.00, description: "Each cupcake is a miniature masterpiece, featuring delicately crafted edible flowers that bloom in a symphony of colors and shapes. From daisies to lavender buds, every petal is a work of art. Whether it's a lavender-infused vanilla, rose-petal kissed frosting, or a hibiscus-infused surprise, the flavors are as delicate and delightful as the flowers themselves.", vip_price: 3.50, category: 'Holidays', productImage: flowerpotCupcakes_image }),
    createProduct({ name: 'Rose Dreams', price: 50.00, description: `Our "Rose Petal Dreams" birthday cake is a breathtaking creation that brings the timeless beauty of roses to the forefront. Layers of moist cake are adorned with delicate fondant roses, creating a sumptuous and visually stunning centerpiece for your celebration. Delight in the subtle infusion of rose essence within each layer. The cake's flavor profile mirrors the delicate fragrance of roses, offering a sensory experience that is both indulgent and refined.`, vip_price: 0, category: 'Birthdays', productImage: goldBlackCake_image }),
    createProduct({ name: 'Haunted Delights', price: 5.00, description: ` Our "Haunted Delights" Halloween cupcakes are a wickedly delightful treat that brings the spirit of Halloween to your taste buds. Each bite is a journey through a world of spooky flavors and festive fun. Delve into the rich and decadent chocolate flavors that make these cupcakes a sinister delight.`, vip_price: 0, category: 'Holidays', productImage: halloweenCupcakes_image }),
    createProduct({ name: 'Classic Vanilla Celebration', price: 50.00, description: 'Dive into layers of moist and velvety vanilla sponge that offer a delicate crumb and a melt-in-your-mouth experience. Savor the rich aroma and distinct sweetness of Madagascar vanilla, infusing every bite with a warm and comforting essence. The cake is generously coated with a luscious layer of smooth vanilla buttercream, adding a creamy and dreamy finish. ', vip_price: 0, category: 'Birthdays', productImage: helloKitty_image }),
    createProduct({ name: 'Citrus Splash Delight', price: 4.50, description: ` Our "Citrus Splash Delight" Margarita Cupcakes are a sweet tropical escape in every bite. Inspired by the classic cocktail, these cupcakes bring the lively and refreshing flavors of a Margarita to your dessert table. `, vip_price: 0, category: 'Cupcakes', productImage: keylimeCupcakes_image }),
    createProduct({ name: "Gone Wild", price: 40.00, description: "Brace yourself for a wild flavor adventure! Each layer of this crazy cake is a different explosion of flavors, from cotton candy dreams to zesty citrus twirls, creating a rollercoaster for your taste buds.", vip_price: 0, category: 'Special Occasions', productImage: maybeImCrazyCake_image }),
    createProduct({ name: 'Fusion Delight', price: 35.00, description: 'Experience a delightful crunch with every mouthful as an assortment of nuts—walnuts, almonds, and hazelnuts—adds a layer of nutty perfection. The nuts are generously scattered throughout the cake, creating a textural masterpiece that adds depth to each slice. ', vip_price: 0, category: 'Holidays', productImage: mistletoeCake_image }),
    ...
    createProduct({ name: 'Cookie Delight', price: 60.00, description: 'The entire cake is enveloped in a cloud of whipped vanilla frosting, adding a light and airy touch to the indulgent treat. The vanilla complements the chocolate and Oreo flavors, creating a well-rounded and delightful dessert. This Oreo Cookies Cake is a guaranteed hit at any celebration.', vip_price: 0, category: 'Special Occasions', productImage: oreoCake_image }),
    createProduct({ name: 'Blushing Blossom', price: 4.50, description: 'The cupcakes boast a light and airy vanilla base that perfectly complements the gentle pink tones. The subtle sweetness creates a delightful harmony that dances on the taste buds with every bite.', vip_price: 0, category: 'Cupcakes', productImage: prettyInPinkCupcake_image }),
    createProduct({ name: 'Macaron Whispers', price: 60.00, description: "The cake features layers of velvety pink sponge, delicately infused with a hint of vanilla. Each bite is a journey through a cloud-like crumb, creating a sensation of pure indulgence. Adorning the cake are an array of dainty macarons, gracefully standing atop like edible jewels. The macarons, in shades complementing the pastel pink, add a touch of French elegance and whimsy to the overall design.", vip_price: 0, category: 'Birthdays', productImage: princessCake_image }),
    createProduct({ name: 'Rainbow Symphony', price: 40.00, description: `A cascade of edible confetti in matching rainbow shades adorns the top, creating a festive rain of colors. The confetti is a joyful touch that adds movement and excitement to the cake's presentation.  Each bite is a delightful journey through the rainbow spectrum.`, vip_price: 30.00, category: 'Birthdays', productImage: rainbowCake_image }),
    createProduct({ name: 'Candy Kaleidoscope', price: 45.00, description: 'This cake is a celebration of color, fun, and the irresistible crunch of these candy-coated chocolate gems. Adorning the cake are cascading waterfalls of M&M candies in every color of the rainbow. The candies create a playful and dynamic design, ensuring that each slice is a delightful journey through a candy wonderland.', vip_price: 0, category: 'Birthdays', productImage: skittlesCake_image }),
    createProduct({ name: 'Enchanting Peony', price: 70.00, description: "The color palette of soft pinks, creams, and blush tones mirrors the delicate hues of peonies in full bloom. The cake exudes a sense of romance and sophistication, making it a perfect centerpiece for weddings, anniversaries, or any celebration of love.", vip_price: 0, category: 'Special Occasions', productImage: peonyCake_image }),
    createProduct({ name: 'Gingerbread Frost', price: 45.00, description: ' Edible gingerbread houses, adorned with intricate icing details, create a charming village scene atop the cake. ', vip_price: 0, category: 'Holidays', productImage: snowHouseCake_image }),
    createProduct({ name: 'Wafer Bliss', price: 45.00, description: "Surrounding the cake sits a crown of wafer rolls, standing tall and proud. These wafer roll peaks invite you to embark on a delightful journey of alternating textures — the smoothness of chocolate, the moistness of cake, and the satisfying crunch of wafer rolls.", vip_price: 0, category: 'Birthdays', productImage: soccerDirtCake_image }),
    createProduct({ name: 'Harvest Spice Delight', price: 40.00, description: 'Immerse yourself in a symphony of spices — cinnamon, nutmeg, and cloves — that dance together harmoniously. The warm spices complement the pumpkin, creating a medley of flavors that evokes the nostalgia of autumn gatherings and cozy evenings by the fireplace.', vip_price: 0, category: 'Holidays', productImage: thanksgivingCake_image }),
