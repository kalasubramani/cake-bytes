...
import api from "./api";
import { Box, Button, Card, Divider, List, ListItem, ListItemButton, ListItemText, TextField, Typography } from '@mui/material';
...
const ProfileSettings = ({ user, setUser }) => {
  ...
  const profileUserAddress = () => {
    return (
      <Box sx={{ flexGrow: 1, p: "1rem" }}>
        {!addressLine1?.length ?
          <Card sx={{ mt: "1rem",mb:"10rem", p: "1rem" }} >
            <Typography>We do not have your address details. Please click Edit to update your address.</Typography>
          </Card>
          :
          <>
            <Typography variant="h5">
